...
<head>
    ...
    function getVote(int) {
      ...
      xmlhttp.open("GET","poll_6_vote.php?vote="+int,true);
      xmlhttp.send();
    }
    </script>
    <style>      
...
/*            background-position: center;
    ...
    <body>
        ...
        <main class="w3-container w3-card-4 w3-light-grey w3-margin-bottom w3-twothird">
            ...
            <h3>Assuming Joe Biden wins the democratic primary and Donald Trump does not get impeached, who would you choose?</h3>
            <form>
                Joe Biden:
            ...
            <div id="previous" class="w3-margin-top w3-margin-bottom">
                <a href="../Poll_5/poll_5.php">Previous</a>                
            </div>
            <div id="next" class="w3-margin-top w3-margin-bottom">
                <a href="../countdown.php">Next</a>
            </div>
        </main>
