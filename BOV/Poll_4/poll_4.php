...
<html>
    ...
    function getVote(int) {
      ...
      xmlhttp.open("GET","poll_4_vote.php?vote="+int,true);
      xmlhttp.send();
    }
    </script>
    <style>      
    ...
    <body>
        ...
        <main class="w3-container w3-card-4 w3-light-grey w3-margin-bottom w3-twothird">
            ...
            <h3>Our next president's 1st term's main focus should be?</h3>
            <form>
            US Student Debt:
            ...
            <div id="previous" class="w3-margin-top w3-margin-bottom">
                <a href="../Poll_3/poll_3.php">Previous</a>
            </div>
            <div id="next" class="w3-margin-top w3-margin-bottom">
                <a href="../Poll_5/poll_5.php">Next</a>
            </div>
        </main>
