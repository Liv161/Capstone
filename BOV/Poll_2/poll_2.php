...
<head>
    ...
    function getVote(int) {
      ...
      xmlhttp.open("GET","poll_2_vote.php?vote="+int,true);
      xmlhttp.send();
    }
    </script>
    <style>      
    ...
    <body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="../Credentials/logout.php"hme><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
                </ul>
              </div>
            </div>
         </nav>
        <main class="w3-container w3-card-4 w3-light-grey w3-margin-bottom w3-twothird">
            ...
            <h3>In a field as crowded as the democrats, who would you want to see win the primary election?</h3>
            <form>
            Joe Biden:
            ...
            <div id="previous" class="w3-margin-top w3-margin-bottom">
                <a href="../Poll_1/poll_1.php">Previous</a>                
            </div>
            <div id="next" class="w3-margin-top w3-margin-bottom">
                <a href="../Poll_3/poll_3.php">Next</a>
            </div>
        </main>
