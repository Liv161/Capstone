...
<html>
<head>
    <title>Republican Culture</title>
    <meta charset="UTF-8">
    ...
    function getVote(int) {
      ...
      xmlhttp.open("GET","poll_3_vote.php?vote="+int,true);
      xmlhttp.send();
    }
    </script>
    <style>      
    ...
    <body>
        ...
        <main class="w3-container w3-card-4 w3-light-grey w3-margin-bottom w3-twothird">
            ...
            <h3>Is the party of "Lincoln" dead?</h3>
            <form>
            Exactly the same:
            ...
            <div id="previous" class="w3-margin-top w3-margin-bottom">
                <a href="../Poll_2/poll_2.php">Previous</a>
            </div>
            <div id="next" class="w3-margin-top w3-margin-bottom">
                <a href="../Poll_4/poll_4.php">Next</a>
            </div>
        </main>
